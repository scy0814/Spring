...
public class TransactionDAO {
	...
	private static String GET_TRANSACTION_HISTORY = "select * from transaction where accountNum1 = ? order by t_date desc";
	...
	public List<TransactionVO> getTransactionHistoryByAccountNum(TransactionVO vo) {
		...
		try {
			...
			while(rs.next()) {
				...
				System.out.println("t_amount : " + transaction.getT_amount());
				System.out.println("b : " + transaction.getT_balance());
